  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Front-end engineering portfolio for Lewis Saunders, featuring professional product work, personal projects, and experience across modern web platforms." />
      </Head>
        ...
        <main className='flex flex-col items-center text-dark w-full min-h-screen'>
                ...
                <div className='bg-lightGrey'>
                    <div className='py-16 px-12 flex flex-col'>
                      ...
                      Front-end engineer with strong experience building modern web products using React, Next.js, and TypeScript. I&apos;ve delivered customer-facing features across large-scale platforms, worked comfortably within Agile teams, and built a reputation for producing clean, dependable interfaces under tight deadlines.
                        </p>
