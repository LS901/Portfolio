...
const Skills = () => {
    return (<>
        <AnimatedText text='Primary Skills' className='font-bold text-5xl mt-32 py-20 w-full text-center mb-4 border-t-4 border-earthFive/50 tablet:!text-xl' />
        <div className='w-full h-auto relative grid-cols-4 tablet:grid-cols-2 grid'>
