...
export const GithubIcon = ({ className, fill= false, ...rest  }) => (
    <svg
        ...
        viewBox="0 0 512 512"
        {...rest}
        className={`w-full h-auto ${className} rounded-md`}
    >
        <path fill={fill ? '#FFF' :'#000'} d="M0 0h512v512H0z" />
        <path
            fill={fill ? '#000' :'#FFF'}
...
export const LinkedInIcon = ({ className, fill= false, ...rest }) => (    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
        viewBox="0 0 256 256"
    ...
    >
        <g fill="none">
            ...
            <rect width={256} height={256} fill={fill ? '#FFF' : '#000'} rx={60} />
            <path
                fill={fill ? '#000' : '#FFF'}
...
export const InstagramIcon = ({ className, fill= false, ...rest }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
    ...
    >
        ...
        <path
            fill={fill ? '#000' : '#FFF'}
            d="M128 80a48 48 0 1 0 48 48 48.05 48.05 0 0 0-48-48Zm0 80a32 32 0 1 1 32-32 32 32 0 0 1-32 32Zm52-100a12 12 0 1 1-12-12 12 12 0 0 1 12 12Zm32 12.4c-.7-15.7-4.3-29.6-15.8-41.1S172.3 16.7 156.6 16C140.4 15.1 91.6 15.1 75.4 16c-15.7.7-29.6 4.3-41.1 15.8S16.7 55.7 16 71.4C15.1 87.6 15.1 136.4 16 152.6c.7 15.7 4.3 29.6 15.8 41.1S55.7 209.3 71.4 210c16.2.9 65 .9 81.2 0 15.7-.7 29.6-4.3 41.1-15.8s15.1-25.4 15.8-41.1c.9-16.2.9-64.9 0-81.1Zm-19 98.5a32.4 32.4 0 0 1-18.3 18.3c-12.7 5-42.8 3.9-56.7 3.9s-44.1 1-56.7-3.9a32.4 32.4 0 0 1-18.3-18.3c-5-12.7-3.9-42.8-3.9-56.7s-1-44.1 3.9-56.7a32.4 32.4 0 0 1 18.3-18.3c12.7-5 42.8-3.9 56.7-3.9s44.1-1 56.7 3.9a32.4 32.4 0 0 1 18.3 18.3c5 12.7 3.9 42.8 3.9 56.7s1.1 44-3.9 56.7Z"
        />
    </svg>
);
...
export const HandEmoji = ({ className, ...rest }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={800}
        height={800}
